...
struct FSMData {
  ...
  ros::Time last_idle_recovery_time_;
  ros::Time last_remote_map_replan_time_;
...
struct FSMParam {
  ...
  double idle_retry_interval_;
  bool auto_start_;
  double auto_start_retry_interval_;
  double remote_map_replan_interval_;
